...
H5PEditor.language['H5PEditor.InteractiveVideo'] = {
  libraryStrings: {
    ...
    tourStepUploadFileText: '<p>Start by adding a video file. You can upload a file from your computer or embed a video from YouTube.</p><p>To ensure compatibility across browsers, you can upload multiple file formats of the same video, such as mp4 and webm</p>',
    ...
    tourStepCanvasEditingText: '<p>Once an interaction has been added, you can drag to reposition it.</p><p>To resize an interaction, press the lower right corner and drag</p><p>To edit the content of an interaction, double click on it and an editor will appear. You can delete the interaction from within the editor, or by using the context menu available when selecting an interaction</p>',
